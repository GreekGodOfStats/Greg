--clear source tables
DELETE FROM Matchups.dbo.per_100_2019_20
WHERE PLAYER_ID != '';
DELETE FROM Matchups.dbo.per_game_2019_20
WHERE PLAYER_ID != '';
DELETE FROM Matchups.dbo.hustle_2019_20
WHERE PLAYER_ID != '';
DELETE FROM Matchups.dbo.teammatchupdata
WHERE DEF_PLAYER_ID != '';

--bulk insert source tables
BULK INSERT Matchups.dbo.per_game_2019_20
FROM 'C:\Users\gsteele\per_game_2019-20.csv'
WITH (
FIRSTROW = 2,
FIELDTERMINATOR = ',',
ROWTERMINATOR = '\n'
);
BULK INSERT Matchups.dbo.per_100_2019_20
FROM 'C:\Users\gsteele\per_100_2019-20.csv'
WITH (
FIRSTROW = 2,
FIELDTERMINATOR = ',',
ROWTERMINATOR = '\n'
);
BULK INSERT Matchups.dbo.hustle_2019_20
FROM 'C:\Users\gsteele\hustle_2019-20.csv'
WITH (
FIRSTROW = 2,
FIELDTERMINATOR = ',',
ROWTERMINATOR = '\n'
);
BULK INSERT Matchups.dbo.teammatchupdata
FROM 'C:\Users\gsteele\teammatchupdata.csv'
WITH (
FIRSTROW = 2,
FIELDTERMINATOR = ',',
ROWTERMINATOR = '\n'
...
INTO Matchups.dbo.updated
FROM Matchups.dbo.gamma
JOIN C
ON TEAM_ID_ = squad;
ALTER TABLE Matchups.dbo.updated
